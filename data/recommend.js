...
(function () {
  ...
  const ARCHETYPES = [
    // ---- Solo (1 player) ----
    { id: 'solo-attrition', title: 'Attrition Fighter', tag: 'Solo',
    ...
    { id: 'solo-weatherproof', title: 'Weather-Proof Grinder', tag: 'Solo',
    ...
    { id: 'solo-egg-loop', title: 'Egg Economy Loop', tag: 'Solo', requiresExpansion: true,
    ...
    // ---- Squads (2+) ----
    { id: 'balanced-core', title: 'Balanced Core', tag: 'All-Rounder',
    ...
    { id: 'grub-guild', title: 'Grub Guild', tag: 'Grub Synergy',
    ...
    { id: 'egg-economy', title: 'Egg Economy Engine', tag: 'Economy',
    ...
    { id: 'universal-buff', title: 'Universal Buff Core', tag: 'Support',
    ...
    { id: 'weather-fortress', title: 'Weather-Immune Fortress', tag: 'Weather Denial',
    ...
    { id: 'tank-glasscannon', title: 'Tank & Glass Cannon', tag: 'Tank + Damage',
    ...
    { id: 'mobility-recon', title: 'Mobility & Recon', tag: 'Utility',
    ...
    { id: 'card-control', title: 'Card Control Engine', tag: 'Control',
    ...
    { id: 'glass-cannon-gambit', title: 'Glass Cannon Gambit', tag: 'High Variance',
  ...
  function suggestTeams({ players, expansion, difficulty, predators }) {
    ...
    const viable = ARCHETYPES.filter(a => N >= a.minPlayers && N <= a.maxPlayers)
      .map(a => {
    ...
    const results = viable.slice(0, 5).map(({ archetype, avail, locked }) => {
      ...
      return {
        ...
        blurb: archetype.blurb, caution: archetype.caution || null,
        squad, covers,
  ...
  function analyzeTeam(teamNames) {
    const roster = rosterNames();
    ...
    return { picked, gaps, combos, pace, grubPickers };
  }
